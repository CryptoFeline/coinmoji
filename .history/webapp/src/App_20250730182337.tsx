      ...
      <main className="flex-1 flex flex-col px-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="bg-whit-500 text-white font-medium py-3 px-4 rounded-lg hover:bg-orange-600 active:scale-95 transition-all duration-150 flex items-center justify-center space-x-2 shadow-sm"
          >
