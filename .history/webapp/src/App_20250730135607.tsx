...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 flex flex-col">
      {/* Header */}
      <header className="bg-white/10 backdrop-blur-md border-b border-white/10 px-4 py-4 flex items-center justify-between sticky top-0 z-30">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-xl flex items-center justify-center shadow-lg">
            <span className="text-xl">🪙</span>
          </div>
          <div>
            <h1 className="text-white font-bold text-xl">Coinmoji</h1>
            {user && (
              <p className="text-white/70 text-sm">Hey {user.first_name}! 👋</p>
            )}
          </div>
        </div>
      </header>
      ...
      <div className="px-4 pt-4">
        <button
          ...
          className="w-full bg-white/10 backdrop-blur-md border border-white/20 text-white font-semibold py-4 px-6 rounded-2xl shadow-lg hover:bg-white/15 transition-all duration-200 flex items-center justify-center space-x-3"
        >
      ...
      <main className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-4">
          <div className="bg-black/20 backdrop-blur-sm rounded-2xl border border-white/10 h-full shadow-2xl">
            <CoinEditor 
              className="h-full" 
