      ...
      <main className="flex-1 flex flex-col px-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <button
            ...
            className="bg-white text-gray-700 font-medium py-3 px-4 rounded-lg border-2 hover:border active:scale-95 transition-all duration-150 flex items-center justify-center space-x-2 shadow-sm"
          >
