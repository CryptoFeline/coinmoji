      ...
      .then((texture) => {
        ...
        if (currentSettings.dualOverlay && isSecond) {
          ...
          if (texture instanceof THREE.VideoTexture) {
            ...
            // rotate it 180 degrees to match the top face
            bottomTexture.rotation = Math.PI; // Rotate 180 degrees
            bottomTexture.anisotropy = sceneRef.current!.renderer.capabilities.getMaxAnisropy();
