...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ isOpen, onClose, settings, onSettingsChange }) => {
  ...
  return (
    <>
      ...
      <div className="fixed top-20 left-4 right-4 bg-white rounded-xl shadow-lg z-50 max-h-[calc(100vh-6rem)] overflow-y-auto border-2 border-gray-200">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <h2 className="text-lg font-medium text-gray-900">Coin Editor</h2>
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-lg bg-gray-100 hover:bg-gray-200 flex items-center justify-center transition-colors border border-gray-200"
          >
        ...
        <div className="p-4 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              <input
                ...
                className="w-full px-3 py-2 bg-gray-50 border-2 border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
              />
              <div className="flex space-x-2">
                <button 
                  onClick={handleApplyBodyTexture}
                  className="flex-1 bg-white border-2 border-blue-500 text-blue-600 font-medium py-2 px-3 rounded-lg transition-colors hover:bg-blue-50 text-sm"
                >
                  Apply Texture
                </button>
                <button 
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Animation Speed</h3>
          ...
          {/* Overlay Images */}
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-gray-900">Face Images</h3>
            
            <div className="flex items-center justify-between">
              <div>
                <span className="text-gray-900 font-medium">Different Images</span>
