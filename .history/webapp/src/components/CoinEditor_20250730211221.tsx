...
const CoinEditor: React.FC<CoinEditorProps> = ({ className = '', settings: externalSettings }) => {
  ...
  const clearOverlays = (invalidate: boolean = true) => {
    ...
    console.log('clearOverlays called with invalidate:', invalidate);
    ...
    console.log('Before clear - overlay visibility:', {
      topVisible: sceneRef.current.overlayTop.visible,
      botVisible: sceneRef.current.overlayBot.visible,
      topHasMap: !!topMaterial.map,
      botHasMap: !!botMaterial.map
    });
    ...
    console.log('After clear - overlay visibility:', {
      topVisible: sceneRef.current.overlayTop.visible,
      botVisible: sceneRef.current.overlayBot.visible,
      topHasMap: !!topMaterial.map,
      botHasMap: !!botMaterial.map
  ...
  useEffect(() => {
    ...
    if (nothingToShow) {
      console.log('Clearing overlays due to no URLs');
    ...
    if (currentSettings.overlayUrl && currentSettings.overlayUrl.trim() !== '') {
      console.log('Applying overlay 1:', currentSettings.overlayUrl);
    ...
    if (currentSettings.dualOverlay && currentSettings.overlayUrl2 && currentSettings.overlayUrl2.trim() !== '') {
      console.log('Applying overlay 2:', currentSettings.overlayUrl2);
