...
const CoinEditor: React.FC<CoinEditorProps> = ({ className = '' }) => {
  ...
  const [settings] = useState<CoinSettings>({
    fillMode: 'solid',
    bodyColor: '#b87333',
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      sceneRef.current.turntable.rotation.y += speedMap[settings.rotationSpeed];
