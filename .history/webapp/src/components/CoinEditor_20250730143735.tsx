    ...
    if (currentSettings.bodyTextureUrl) {
      ...
      createTextureFromUrl(currentSettings.bodyTextureUrl)
        .then((texture) => {
          ...
          rimMat.map = null; // Keep rim without texture for now
          faceMat.map = texture;
          rimMat.color.set(currentSettings.bodyColor); // Keep rim color
          faceMat.color.set('#ffffff'); // White to show texture properly
